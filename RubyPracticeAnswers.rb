...
class DistanceConverter
	...
	attr_reader :centimeters, :inches
end
...
class ProjectMeasurements
	...
	def add( measurementName, feet, inches )
		oneMeasurement = DistanceConverter.new( feet, inches )
		@measurements[measurementName] = oneMeasurement
	end
	...
	def addTwoMeasurementsInInches( measurementName1, measurementName2 )
		getMeasurementInches(measurementName1) + getMeasurementInches(measurementName2)
	end
